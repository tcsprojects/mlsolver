...
let get_modelchecking_game (((r, fmls, props, vars) as fml): decomposed_mmc_formula)
...
let modelchecking_proc formula in_chan options (info_chan, formula_chan, constr_chan) =
	...
	info_msg (fun _ -> "Modelchecking Procedure For Modal Mu Calculus\n");
