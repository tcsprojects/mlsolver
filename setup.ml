...
(* OASIS_START *)
(* DO NOT EDIT (digest: 29fa9f06dccf70411b80bd704488914b) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/tcsprojects/mlsolver";
          bugreports = None;
          synopsis =
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/tcsprojects/mlsolver.git";
                      src_repo_browser =
                        Some "https://github.com/tcsprojects/mlsolver";
                   ...
                   },
                   {
                      lib_modules =
                        [
                           ...
                           "pgsolvers/Pgsolvers";
                           "pgsolvers/Pgsolver";
                           "pgsolvers/Externalsolver";
                           "automata/Modelcheckinggames";
                           "automata/Validitygames";
                           "automata/ctl/Ctlmodelcheckinggame";
                           "automata/ctl/Ctlvaliditygame";
                           "automata/ctlstar/Ctlstarmodelcheckinggame";
                           "automata/ctlstar/Ctlstarvaliditygame";
                           "automata/lmmc/Lmmcmodelcheckinggame";
                           "automata/lmmc/Lmmcvaliditygame";
                           "automata/ltmc/Ltmcmodelcheckinggame";
                           "automata/ltmc/Ltmcvaliditygame";
                           "automata/mmc/Mmcmodelcheckinggame";
                           "automata/mmc/Mmcvaliditygame";
                           "automata/pdl/Pdlmodelcheckinggame";
                           "automata/pdl/Pdlvaliditygame"
                        ];
                      lib_pack = false;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/mlsolver";
                      bs_compiled_object = Byte;
                      bs_build_depends = [InternalLibrary "mlsolver"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "mlsolver.ml"});
               Executable
                 ({
                     cs_name = "guarded_trafo_worst_case-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "guarded_trafo_worst_case.ml"
                   });
               Executable
                 ({
                     cs_name = "ctlstarsudoku-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "ctlstarsudoku.ml"});
               Executable
                 ({
                     cs_name = "elevatorts-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "elevatorts.ml"});
               Executable
                 ({
                     cs_name = "ltmcparitybuechi-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "ltmcparitybuechi.ml"
                   });
               Executable
                 ({
                     cs_name = "mucalcsudoku-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "mucalcsudoku.ml"});
               Executable
                 ({
                     cs_name = "pdlsudoku-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "pdlsudoku.ml"});
               Executable
                 ({
                     cs_name = "philosophersts-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "philosophersts.ml"})
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "(\005\243}\003/\183hke\219\162\160\155\1991";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
